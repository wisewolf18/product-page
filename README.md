...
<div align="center">
 <h1>E-commerce product page solution</h1>
 <h3>
    <!-- Github Pages Live -->
    <a href="https://mohamedaridah.github.io/frontendmentor_e-commerce-product-page/">
      Live
    </a>
    <span>&nbsp;|&nbsp;</span>
    <!-- Frontend Mentor Live solution -->
    <a href="https://www.frontendmentor.io/solutions/ecommerce-product-page-solution-using-vanilla-javascript-and-scss-ryTzQO7H9" title="Check My Solution on Frontend Mentor">
      Solution
    </a>
    <span>&nbsp;|&nbsp;</span>
    <!-- Frontend Mentor Challenge Link -->
    <a href="https://www.frontendmentor.io/challenges/ecommerce-product-page-UPsZ9MJp6" title="Original Frontend Mentor Challenge Link">
      Challenge
    </a>
  </h3>
  <div>
...
This is my <strong>10<sup>th</sup></strong> Frontend Mentor challenge.
